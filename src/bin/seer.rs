...
impl LongOp {
    ...
    /// folded into the builder; for Search, records walked.
    fn records(&self) -> u64 {
        match self {
    ...
    /// Verb shown in the progress bar — "Computing summary" or
    /// "Searching" — so the user knows what they're waiting on.
